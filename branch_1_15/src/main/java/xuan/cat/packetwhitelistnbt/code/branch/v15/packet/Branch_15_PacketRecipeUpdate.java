...
import xuan.cat.packetwhitelistnbt.code.branch.v15.Branch_15_RecipeSerializer;

import java.lang.reflect.Field;
import java.util.ArrayList;
import java.util.List;

public final class Branch_15_PacketRecipeUpdate {
    private final PacketPlayOutRecipeUpdate packet;

    public Branch_15_PacketRecipeUpdate(PacketPlayOutRecipeUpdate packet) {
        this.packet = packet;
    }
