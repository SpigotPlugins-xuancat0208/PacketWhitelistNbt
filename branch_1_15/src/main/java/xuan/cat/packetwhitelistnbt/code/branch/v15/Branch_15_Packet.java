...
import xuan.cat.packetwhitelistnbt.code.branch.v15.packet.*;
...
public final class Branch_15_Packet implements BranchPacket {
    ...
    public void convertWindowMerchants(PacketOpenWindowMerchantEvent event, Function<org.bukkit.inventory.MerchantRecipe, org.bukkit.inventory.MerchantRecipe> convert) {
        Branch_15_PacketOpenWindowMerchant packet = new Branch_15_PacketOpenWindowMerchant((PacketPlayOutOpenWindowMerchant) event.getPacket());
